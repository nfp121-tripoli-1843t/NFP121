...
public class AuditeurCNAMTest extends junit.framework.TestCase {
    ...
    {
        question3.AuditeurCNAM auditeur1 = new question3.AuditeurCNAM("najjáâãr", "eliana", "eliana123");
    }
    ...
    public void test44()
    {
        question3.AuditeurCNAM auditeur1 = new question3.AuditeurCNAM("eliana", "najjãr123"  , "dd");
        assertEquals("eliana_n", auditeur1.login());
        assertEquals("dd", auditeur1.matricule());
        assertEquals("najjãr123", auditeur1.prenom());
    }

    public void test21()
    {
        question3.AuditeurCNAM auditeur1 = new question3.AuditeurCNAM("r izk", "ròni", "rizk123");
